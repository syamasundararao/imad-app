...
app.post('/create-user',function(req,res)
{
   ...
   pool.query(`INSERT INTO "test_user1" (username,password) values($1,$2)`,[username,dbString],function(err,result)
   {
...
app.post('/login',function(req,res)
{
   ...
   pool.query(`SELECT *from "test_user1"  where username=$1`,[username],function(err,result)
   {
